...
function t(e){return(t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(e)}var e=require("path"),r=require("tailwindcss/lib/util/resolveConfig").default,n=require("tailwindcss/stubs/defaultConfig.stub"),o=function(r){if("object"===t(r))return r;if(void 0===r)return{};if("string"==typeof r)try{return require(e.resolve(e.dirname(module.parent.filename),r))}catch(n){throw new Error("Could not find config at ".concat(r," relative to ").concat(e.dirname(module.parent.filename),". Please check the relative file path provided or else import your config and pass that."))}throw new TypeError("Invalid input. Please provide the path to a Tailwind CSS config file or the config object itself.")};module.exports={config:function(t){return r([o(t),n])},corePlugins:function(t){return r([o(t),n]).corePlugins},important:function(t){return r([o(t),n]).important},plugins:function(t){return r([o(t),n]).plugins},prefix:function(t){return r([o(t),n]).prefix},separator:function(t){return r([o(t),n]).separator},theme:function(t){return r([o(t),n]).theme},variants:function(t){return r([o(t),n]).variants}};
